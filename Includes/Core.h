...
#include <Windows.h>
enum class Color: unsigned short	//색상 열거형 - 명시적 형변환
{
...
////---------------열거형 참고용
////참고용 :암묵적형변환, : 옛날방식
//enum class Color: unsigned short	//색상 열거형 - 명시적 형변환 ->강타입
//{
//	Red = FOREGROUND_RED,		//1
//	Green = FOREGROUND_GREEN,	//2
//	Blue = FOREGROUND_BLUE,		//4
...
//}
//
////참고용 ㅣ 일반형변형 -> 호출 시 파라미터 넘길때, 숫자로 자동 변환되니, 숫자로 안쓰려고 할때, 문제가 되고ㅡ 명확하지 않아서, 강타입으로 만든 문법이
//enum EColor{	// -> enum class Color: unsigned short 명시화 하기위한 강타입!으로 해줌.
//	Red = FOREGROUND_RED,		//1
//	Green = FOREGROUND_GREEN,	//2
//	Blue = FOREGROUND_BLUE,		//4
//	White = Red+Green +Blue,	//7
